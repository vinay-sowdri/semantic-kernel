...
namespace SemanticKernelTraining.FlightToolPlugin
{
    /// <summary>
    /// Plugin for flight search and booking operations
    /// </summary>
    public class FlightToolPlugin
    {
        private readonly IFlightService _flightService;

        /// <summary>
        /// Initializes a new instance of FlightToolPlugin
        /// </summary>
        /// <param name="flightService">Flight service instance</param>
        public FlightToolPlugin(IFlightService flightService)
        {
